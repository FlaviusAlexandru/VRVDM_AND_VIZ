...
IL2CPP_EXTERN_C IL2CPP_METHOD_ATTR void AudioListener_GetSpectrumDataHelper_m2631C609AB0CC9ED84EB55C939EDC78456E0482F (SingleU5BU5D_t89DEFE97BCEDB5857010E79ECE0F52CF6E93B87C* ___0_samples, int32_t ___1_channel, int32_t ___2_window, const RuntimeMethod* method) 
{
	...
	}
	{
		...
		NullCheck(L_3);
		uintptr_t L_4 = (il2cpp_codegen_conv<uintptr_t,float*,intptr_t,false,false>(((L_3)->GetAddressAt(static_cast<il2cpp_array_size_t>(0))),NULL));
		...
		BlittableArrayWrapper__ctor_mD7869B76C6745D311B8FD895EF3C29428E568971_inline((&V_0), (void*)L_4, L_6, NULL);
	}

IL_001b:
	{
		int32_t L_7 = ___1_channel;
		int32_t L_8 = ___2_window;
		AudioListener_GetSpectrumDataHelper_Injected_m6FC86614FE46AB6C3A3E87976ACEF137CC436EBB((&V_0), L_7, L_8, NULL);
		return;
	}
}
...
IL_0023:
	{
		SingleU5BU5D_t89DEFE97BCEDB5857010E79ECE0F52CF6E93B87C* L_6 = ___1_samples;
		if (!L_6)
		{
			G_B7_0 = G_B4_0;
			goto IL_003f;
	...
	}
	{
		...
		NullCheck(L_9);
		uintptr_t L_10 = (il2cpp_codegen_conv<uintptr_t,float*,intptr_t,false,false>(((L_9)->GetAddressAt(static_cast<il2cpp_array_size_t>(0))),NULL));
		...
		BlittableArrayWrapper__ctor_mD7869B76C6745D311B8FD895EF3C29428E568971_inline((&V_0), (void*)L_10, L_12, NULL);
		G_B7_0 = G_B6_0;
	}

IL_003f:
	{
		int32_t L_13 = ___2_channel;
		int32_t L_14 = ___3_window;
		AudioSource_GetSpectrumDataHelper_Injected_m33F1849C9BBB14DF03BABF55F420177272AA7583(G_B7_0, (&V_0), L_13, L_14, NULL);
		return;
	}
}
